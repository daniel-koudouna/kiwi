...
public class FileComparators {
    ...
    public static Comparator<? super URI> WINDOWS_LIKE = new Comparator<URI>() {

        private String str1, str2;
        private int pos1, pos2, len1, len2;

        @Override
        public int compare(URI f1, URI f2) {
//            if (Configuration.isWindows()) {
//                return f1.compareTo(f2);
//            }

            try {
                str1 = f1.toURL().toExternalForm();
            } catch (MalformedURLException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
            try {
                str2 = f2.toURL().toExternalForm();
            } catch (MalformedURLException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
